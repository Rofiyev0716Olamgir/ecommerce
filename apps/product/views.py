...
from .models import (
    Category, Tag, Product, ProductImage, Trade, Wishlist, Rank, Comment
)
...
from .serializers import (
    ...
    TradeSerializer,
    TradePostSerializer, WishListSerializer, WishListPostSerializer, RankSerializer, CommentSerializer
)
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAdminOrReadOnly]
    filter_backends = (SearchFilter, DjangoFilterBackend, DjangoFilterBackend, OrderingFilter)
    search_fields = ['name']
