...
class UserRegisterView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs) :
        ...
        ecommerce_send_email.apply_async("Activate Token Code", token.token, [user.email])
        data = {
            'success': True,
            'detail': 'Activate Token Code has been sent to your email address.',
        }
...
class SendEmailView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        token = UserToken.objects.create(user=user)
        ecommerce_send_email.apply_async(("Activate Token Code", str(token.token), [user.email]), )
        data = {
            'success': True,
            'detail': 'Activate Token Code has been sent to your email address.',
        }
